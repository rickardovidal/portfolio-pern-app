    ...
    const initData = async () => {
        try {
            ...
            if (clientesResponse.data.success) {
                ...
                console.log('Clientes carregados em ProjetosManager:', clientesResponse.data.data);
            } else {
                    ...
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">{editingProject ? 'Editar Projeto' : 'Adicionar Novo Projeto'}</h5>
                            ...
                            <div className="modal-body">
                                <form onSubmit={handleSubmit}>
                                                ...
                                                <div className="col-md-6" key={servico.idServico}>
                                                    <div className="form-check">
                                                        ...
                                                        <label className="form-check-label" htmlFor={`servico-${servico.idServico}`}>
                                                            {servico.designacao_servico} ({parseFloat(servico.preco_base_servico).toLocaleString('pt-PT', { style: 'currency', currency: 'EUR' })})
                                                        </label>
                                                    </div>
                                                </div>
                                            ))}
                                    ...
                                    <div className="modal-footer">
                                        ...
                                        <button type="submit" className="btn btn-primary">{editingProject ? 'Atualizar' : 'Adicionar'} Projeto</button>
                                    </div>
                                </form>
                            </div>
                        </div>
